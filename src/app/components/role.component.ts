    ...
    <div class="page-container">
      <header class="page-header">
        <nav class="breadcrumb">
          ...
          <span class="breadcrumb-current">Role Management</span>
        </nav>
        <h1 class="page-title">Role Management</h1>
        <p class="page-description">Configure roles, permissions, and organizational structure</p>
      </header>
          ...
          <table class="data-table">
            ...
            <tbody>
              <tr *ngFor="let role of roles">
                ...
                <td>{{ role.reportingManager }}</td>
                <td>
                  <span class="project-badge">{{ role.projectAssigned }}</span>
                </td>
                <td class="actions">
                  <button class="btn-icon btn-edit" (click)="editRole(role)" title="Edit">
                    <i class="fas fa-edit"></i>
                  </button>
                  <button class="btn-icon btn-delete" (click)="deleteRole(role.id)" title="Delete">
          ...
          <form (ngSubmit)="saveRole()" #roleForm="ngForm">
            ...
            <div class="form-group">
              ...
              <input 
                type="text" 
                id="reportingManager" 
                [(ngModel)]="currentRole.reportingManager" 
            ...
            <div class="form-group">
              ...
              <input 
                type="text" 
                id="projectAssigned" 
                [(ngModel)]="currentRole.projectAssigned" 
